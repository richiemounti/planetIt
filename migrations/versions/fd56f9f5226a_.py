...
Revision ID: fd56f9f5226a
Revises: 
Create Date: 2019-04-30 10:09:17.687557
...
def upgrade():
    ...
    sa.Column('search_vector', su.TSVectorType(), nullable=True),
    sa.ForeignKeyConstraint(['category_id'], ['categories.id'], ),
    sa.ForeignKeyConstraint(['order_detail_id'], ['order_details.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
    op.create_index('ix_catalog_items_search_vector', 'catalog_items', ['search_vector'], unique=False, postgresql_using='gin')
    ...
    ss.sync_trigger(conn, 'catalog_items', 'search_vector', ['name', 'description'])
